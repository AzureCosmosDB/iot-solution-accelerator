...
Adapted from the [Azure-Samples/active-directory-aspnetcore-webapp-openidconnect-v2](https://github.com/Azure-Samples/active-directory-aspnetcore-webapp-openidconnect-v2) GitHub repo.
...
- [Registering the Azure Active Directory applications and updating the configuration files for this sample using PowerShell scripts](#registering-the-azure-active-directory-applications-and-updating-the-configuration-files-for-this-sample-using-powershell-scripts)
  - [Overview](#overview)
...
2. Run the scripts. See below for the [four options](#four-ways-to-run-the-script) to do that.
3. Open the Visual Studio solution, and in the solution's context menu, choose **Set Startup Projects**.
4. select **Start** for the projects
