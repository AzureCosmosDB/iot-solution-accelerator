...
#> 
   ...
   # Create the IoTSolutionAcceleratorWebApp AAD application
   Write-Host "Creating the AAD application (IoTSolutionAcceleratorWebApp)"
   $webAppAadApplication = New-AzureADApplication -DisplayName "IoTSolutionAcceleratorWebApp" `
                                                  -HomePage "https://localhost:44321/" `
                                                  -LogoutUrl "https://localhost:44321/signout-oidc" `
                                                  -ReplyUrls "https://localhost:44321/", "https://localhost:44321/signin-oidc" `
                                                  -IdentifierUris "https://$tenantName/IoTSolutionAcceleratorWebApp" `
   ...
   Write-Host "Done creating the webApp application (IoTSolutionAcceleratorWebApp)"
